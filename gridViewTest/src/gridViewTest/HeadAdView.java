...
public class HeadAdView {
	...
	private void addView(int index) {
		View view = LayoutInflater.from(context).inflate(R.layout.image_test, null);
			...
			public Object instantiateItem(final ViewGroup container, final int position) {
				...
				view.setOnClickListener(new OnClickListener() {
					...
					public void onClick(View v) {
						...
						Toast.makeText(context, "这是第" + position + "个", 1).show();
					}
				});
	...
	private OnPageChangeListener setPagerChangeListener() {
		return new OnPageChangeListener() {
			...
			/**
			 * @Description: 
			 *               当滑动到第一个页面的前一个页面就设置viewPager当前页面为最后一个页面，反之则设置当前页面为第一个页面
			 * @param arg0
			 *            void 返回类型
			 * @throws:throws
			 */
